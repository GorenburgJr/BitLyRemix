...
export namespace Prisma {
  ...
  */
  ...
  export type UrlOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId" | "fromUrl" | "shortUrl" | "date", ExtArgs["result"]["url"]>
  ...
  export interface UrlDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const urlWithUserIdOnly = await prisma.url.findMany({ select: { userId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Urls and only return the `userId`
     * const urlWithUserIdOnly = await prisma.url.createManyAndReturn({
     *   select: { userId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Urls and only return the `userId`
     * const urlWithUserIdOnly = await prisma.url.updateManyAndReturn({
     *   select: { userId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface UrlFieldRefs {
    ...
    readonly fromUrl: FieldRef<"Url", 'String'>
    readonly shortUrl: FieldRef<"Url", 'String'>
    readonly date: FieldRef<"Url", 'DateTime'>
  }
  ...
  export type RequestOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id", ExtArgs["result"]["request"]>
  ...
  export type UrlWhereInput = {
    ...
    fromUrl?: StringFilter<"Url"> | string
    shortUrl?: StringFilter<"Url"> | string
    date?: DateTimeFilter<"Url"> | Date | string
  }
  ...
  export type UrlScalarWhereWithAggregatesInput = {
    ...
    fromUrl?: StringWithAggregatesFilter<"Url"> | string
    shortUrl?: StringWithAggregatesFilter<"Url"> | string
    date?: DateTimeWithAggregatesFilter<"Url"> | Date | string
  }
  ...
  export type UrlUpdateInput = {
    ...
    fromUrl?: StringFieldUpdateOperationsInput | string
